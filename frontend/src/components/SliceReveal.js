...
export default function SliceReveal() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-32 bg-orquidea-night overflow-hidden min-h-[150vh] flex items-center"
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2 z-10">
            ...
            >
              Nossa farinha de alta performance garante uma alveolagem superior,
              crocância externa e uma umidade interna que preserva o frescor por
              muito mais tempo.
            </motion.p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                {
                  title: "Maciez",
                  desc: "Elasticidade perfeita da malha de glúten.",
                  icon: "☁️",
                },
                {
                  title: "Alveolagem",
                  desc: "Estrutura aerada e leve.",
                  icon: "🧼",
                },
                {
                  title: "Umidade",
                  desc: "Preservação natural do frescor.",
                  icon: "💧",
                },
                {
                  title: "Crocância",
                  desc: "Crosta dourada e resistente.",
                  icon: "🥖",
                },
              ].map((item, i) => (
                <motion.div
                ...
                >
                  ...
                  <p className="text-sm text-orquidea-cream/50 leading-relaxed">
                    {item.desc}
                  </p>
                </motion.div>
              ))}
