...
const Button = React.forwardRef(
  (
    ...
    const variants = {
      primary:
        "bg-orquidea-green text-white hover:bg-orquidea-night shadow-lg shadow-orquidea-green/20",
      secondary:
        "bg-orquidea-cream text-orquidea-green hover:bg-orquidea-light",
      destructive:
        "bg-orquidea-red text-white hover:bg-red-700 shadow-lg shadow-orquidea-red/20",
      outline:
        "border-2 border-orquidea-green text-orquidea-green hover:bg-orquidea-green hover:text-white",
