      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-orquidea-night text-white pt-24">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            <Badge
              variant="gold"
              className="mb-6 px-6 py-2 text-[10px] uppercase tracking-[0.3em]"
            >
              Nossa Essência
            </Badge>
            ...
            <p className="text-orquidea-cream/60 text-xl md:text-2xl max-w-3xl mx-auto font-serif italic leading-relaxed">
              Desde 1953, transformando a excelência do trigo em arte para a sua
              mesa e performance para o seu negócio.
            </p>
          </motion.div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <motion.div {...fadeIn} className="lg:w-1/2">
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="text-orquidea-green text-sm font-black uppercase tracking-[0.3em]">
                  Desde 1953
                </span>
              </div>
              <h2 className="text-4xl md:text-6xl font-black text-slate-900 mb-10 leading-[1.1] tracking-tighter font-serif">
                Uma trajetória de{" "}
                <span className="text-orquidea-gold">excelência</span> e
                tradição.
              </h2>
              <div className="space-y-8 text-lg text-slate-600 leading-relaxed font-medium">
                <p>
                  Fundada em agosto de 1953 pelos irmãos Tondo, na cidade de
                  Pinto Bandeira (RS), a Orquídea nasceu a partir de um pequeno
                  moinho de trigo. Com o passar das décadas, a empresa expandiu
                  sua atuação e consolidou-se como uma das maiores do setor na
                  região Sul do Brasil.
                </p>
                <p>
                  Hoje, contamos com uma das maiores capacidades de moagem do
                  país, atingindo 48 mil toneladas por mês. Nossa evolução é
                  marcada por um compromisso inegociável com a inovação técnica
                  e a pureza dos ingredientes.
                </p>
                <div className="p-8 bg-orquidea-cream/20 rounded-[2.5rem] border border-orquidea-gold/10">
                  <p className="text-orquidea-green font-black italic font-serif text-xl">
                    "Orquídea Profissional é a evolução de uma história sólida,
                    feita sob medida para quem transforma insumos em resultados
                    extraordinários."
                  </p>
                </div>
              </div>
      ...
      <section className="py-32 bg-slate-50">
        <div className="container mx-auto px-4 max-w-6xl text-center mb-24">
          <motion.div {...fadeIn}>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-8 font-serif">
              Aplicações Profissionais
            </h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-lg font-medium leading-relaxed">
              Atendemos todo o setor alimentício com soluções que garantem
              performance superior e padronização em larga escala.
            </p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            {
              title: "Panificação",
              desc: "Mix completo de farinhas e pré-misturas para pães artesanais e industriais.",
              icon: <Wheat size={32} />,
              color: "green",
            },
            {
              title: "Confeitaria",
              desc: "Soluções técnicas para massas leves, bolos e acabamentos profissionais de alta precisão.",
              icon: <Award size={32} />,
              color: "gold",
            },
            {
              title: "Industrial",
              desc: "Produção em larga escala com rigoroso controle de qualidade e suporte técnico especializado.",
                ...
                <CardContent className="p-12">
                  <div
                    className={cn(
                      ...
                      item.color === "green"
                        ? "bg-orquidea-green/10 text-orquidea-green group-hover:bg-orquidea-green group-hover:text-white"
                        : item.color === "gold"
                          ? "bg-orquidea-gold/10 text-orquidea-gold group-hover:bg-orquidea-gold group-hover:text-white"
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-20">
            <motion.div {...fadeIn} className="lg:w-1/2">
              ...
              <h3 className="text-4xl md:text-5xl font-black text-slate-900 mb-10 font-serif leading-tight">
                Presença Estratégica em todo o Brasil.
              </h3>
              <p className="text-lg text-slate-600 mb-10 leading-relaxed font-medium">
                Com sede administrativa em Caxias do Sul (RS) e centros de
                distribuição otimizados, garantimos uma logística robusta para
                parceiros de todos os portes.
              </p>
