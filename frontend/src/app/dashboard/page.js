    ...
    <div className="flex-grow bg-slate-50 pb-20 pt-32">
        ...
        <div className="container mx-auto px-4 relative z-10 max-w-5xl">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            ...
            >
              ...
              <div>
                <p className="text-[10px] text-orquidea-cream/40 font-black uppercase tracking-[0.2em] mb-1">
                  Perfil Ativo
                </p>
                <Badge
                  variant={roleColors[user.role?.toLowerCase()] || "secondary"}
                >
                  {user.role}
                </Badge>
              </div>
      ...
      <div className="container mx-auto px-4 max-w-5xl mt-[-4rem] relative z-20">
        ...
        >
          ...
          {["vendedor", "interno", "admin"].includes(
              ...
              <Link href="/catalogo" className="block group h-full">
                <Card className="h-full border-none shadow-lg hover:shadow-2xl overflow-hidden relative transition-all duration-500 group-hover:-translate-y-2">
                  ...
                  <CardHeader>
                    ...
                    <CardTitle className="text-2xl font-black group-hover:text-orquidea-seller transition-colors">
                      Área Vendedor
                    </CardTitle>
                    <CardDescription className="text-base font-medium">
                      Fichas técnicas, imagens em alta resolução e argumentos de
                      vendas para seu dia a dia.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
          ...
          {["tecnico", "interno", "admin", "profissional"].includes(
            user.role?.toLowerCase(),
          ) && (
            <motion.div variants={itemVariants}>
              <Link href="/treinamentos" className="block group h-full">
                <Card className="h-full border-none shadow-lg hover:shadow-2xl overflow-hidden relative transition-all duration-500 group-hover:-translate-y-2">
                  ...
                  <CardHeader>
                    ...
                    <CardTitle className="text-2xl font-black group-hover:text-orquidea-tech transition-colors">
                      Capacitação Técnica
                    </CardTitle>
                    <CardDescription className="text-base font-medium">
                      Vídeo-aulas, dicas exclusivas e manuais de panificação. O
                      hub de reciclagem profissional.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              <Link href="/catalogo" className="block group">
                <Card className="h-full border-none shadow-lg hover:shadow-2xl overflow-hidden relative transition-all duration-500 group-hover:-translate-y-2">
                  ...
                  <CardHeader>
                    ...
                    <CardTitle className="text-3xl font-black group-hover:text-orquidea-green transition-colors">
                      Área do Cliente
                    </CardTitle>
                    <CardDescription className="text-lg font-medium">
                      Bem-vindo! Acesse nosso catálogo completo e entre em
