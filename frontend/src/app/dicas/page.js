...
export const metadata = {
  ...
  description: 'Aprenda técnicas exclusivas de panificação, confeitaria e segredos da cozinha industrial com nossos mestres técnicos.',
  openGraph: {
    title: 'Dicas e Técnicas Profissionais | Orquídea Profissional',
    description: 'Hub de conhecimento técnico para profissionais da panificação.',
