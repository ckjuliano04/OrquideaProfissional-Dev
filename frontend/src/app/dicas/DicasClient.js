...
export default function DicasClient({ initialTips }) {
  ...
  const filteredTips = initialTips.filter(
    (tip) =>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <Badge
                variant="gold"
                className="mb-10 px-8 py-2.5 text-[10px] uppercase tracking-[0.5em] bg-orquidea-gold text-orquidea-night border-none shadow-2xl shadow-orquidea-gold/20"
              >
                Hub de Conhecimento
              </Badge>
              ...
              <p className="text-orquidea-cream/40 text-xl md:text-2xl max-w-3xl mx-auto font-serif italic leading-relaxed">
                Técnicas exclusivas, segredos da panificação e orientações dos
                nossos mestres para elevar o padrão da sua produção
                profissional.
              </p>
            </motion.div>
          </div>
        ...
        <AnimatePresence mode="wait">
          {filteredTips.length === 0 ? (
            ...
            >
              ...
              <h3 className="text-4xl font-black text-slate-900 mb-6 font-serif">
                Nenhum resultado
              </h3>
              <p className="text-slate-500 text-xl mb-12 leading-relaxed font-serif italic">
                Não encontramos dicas para sua busca. Tente palavras-chave como
                &quot;Pão&quot;, &quot;Pizza&quot; ou &quot;Fermento&quot;.
              </p>
              <Button
                variant="primary"
                onClick={() => setSearchQuery("")}
                className="rounded-full px-16 h-16 text-[10px] uppercase tracking-widest"
              >
                Redescobrir Tudo
              </Button>
            </motion.div>
