...
export function normalizeHomeData(raw) {
  ...
  const defaults = {
    ...
    hero_subtitle:
      "Bem-vindo à plataforma definitiva para profissionais de panificação, confeitaria e culinária.",
    ...
    where_to_buy_text:
      "Nossos produtos profissionais estão disponíveis nos melhores distribuidores.",
