...
from .jucetins import (
    JucetinsScraper,  # TO (JUCETINS - URL migrou para to.gov.br/jucetins)
)
from .jucis_df import JucisDfScraper  # DF
from .jucisrs import (
    JucisrsScraper,  # RS (Playwright - JUCISRS, domínio antigo aposentado)
)


def _make(
    estado: str, junta: str, url: str, municipio_default: str = None
) -> Type[AbstractJuntaScraper]:
