...
class Pages(models.Model):
    ...
    title = models.CharField(
        max_length=150, db_collation="Latin1_General_CI_AS", verbose_name="Título"
    )
    ...
    banner_image_url = models.CharField(
        ...
        blank=True,
        null=True,
        verbose_name="URL da Imagem do Banner",
    )
...
class Stores(models.Model):
    title = models.CharField(
        max_length=150, db_collation="Latin1_General_CI_AS", verbose_name="Nome da Loja"
    )
    description = models.TextField(
        db_collation="Latin1_General_CI_AS",
        blank=True,
    ...
    latitude = models.DecimalField(
        max_digits=10, decimal_places=8, blank=True, null=True, verbose_name="Latitude"
    )
    longitude = models.DecimalField(
        max_digits=11, decimal_places=8, blank=True, null=True, verbose_name="Longitude"
    )
...
class Tips(models.Model):
    ...
    content = models.TextField(
        db_collation="Latin1_General_CI_AS", verbose_name="Conteúdo Completo"
    )
