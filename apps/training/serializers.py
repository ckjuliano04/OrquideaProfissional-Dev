...
from .models import RestrictedFiles, RestrictedMaterials, RestrictedVideos
...
class RestrictedMaterialsDetailSerializer(serializers.ModelSerializer):
    ...
    videos = RestrictedVideosSerializer(
        source="restrictedvideos_set", many=True, read_only=True
    )
